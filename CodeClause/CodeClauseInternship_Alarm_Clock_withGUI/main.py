...
def a():
	...
	if a == "":
		...
		if Alarmtime == CurrentTime:
			mixer.music.load('E:\\CodeClause\\CodeClauseInternship_Alarm_Clock_withGUI\\wake_up.mp3')
			mixer.music.play()
...
alpp = PhotoImage(file='E:\\CodeClause\\CodeClauseInternship_Alarm_Clock_withGUI\\al.png')

alp = Label(panel,image=alpp)
alp.grid(rowspan=4,column=0)


atime = Label(panel,text="Set Alarm Time \n(Hr:Min)",font=('Times 20 italic bold'))
